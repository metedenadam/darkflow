class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('val_summary', './summary_val/', 'path to TensorBoard validation summaries directory')
        self.define('annotation', './logos/annotations/', 'path to annotation directory')
        self.define('val_annotation', './logos_val/annotations/', 'path to validation annotation directory')
        self.define('threshold', -0.1, 'detection threshold')
        self.define('model', './cfg/tiny-yolo-logos.cfg', 'configuration of choice')
        ...
        self.define('save', 2049, 'save checkpoint every ? training examples')
